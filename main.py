...
def init(evManager):
    ...
    print("\nControls:")
    print("Place a piece: Enter, or click on top-left of piece on board (sort of)")
    print("Move a piece: arrow keys, or click on board")
    print("Rotate piece clockwise: x or scroll up")
    print("Rotate piece counterclockwise: z or scroll down")
    print("Flip piece: left shift")
    print("Pick new piece: Click on desired piece of your color in piece tray to right of board")
